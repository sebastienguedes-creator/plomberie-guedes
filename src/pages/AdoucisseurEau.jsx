            ...
            <div className="bg-slate-950 text-slate-100 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <div className="lg:col-span-7 space-y-6">
                                ...
                                <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                                    L'eau en Normandie est particulièrement dure et calcaire[cite: 17]. Je protège vos tuyauteries, votre chauffe-eau et vos appareils ménagers grâce à la pose d'un <strong>adoucisseur d'eau individuel</strong>[cite: 17].
                                </p>
                            ...
                            <div className="lg:col-span-5 bg-slate-900 border border-slate-800 p-8 rounded-3xl space-y-6">
                                ...
                                <ul className="space-y-4 text-sm text-slate-300">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span><strong>Protection des équipements :</strong> Je prolonge la durée de vie de votre chaudière, ballon d'eau chaude et lave-linge[cite: 17].</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Sparkles className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                                        <span><strong>Économies d'énergie :</strong> 1 mm de calcaire augmente votre consommation d'énergie de 10 %[cite: 17].</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Wrench className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                                        <span><strong>Confort au quotidien :</strong> Peau moins sèche, linge plus doux et finie la corvée de tartre[cite: 17].</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <section className="py-16 bg-slate-950 border-b border-slate-800">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto text-sm">
                            J'interviens dans l'ensemble des départements normands, préfectures et sous-préfectures[cite: 17] :
                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    L'eau calcaire se manifeste par des traces blanches sur la robinetterie, du tartre dans les appareils, une peau sèche après la douche et du linge rêche[cite: 17]. Je peux réaliser un test de dureté pour mesurer précisément votre taux de calcaire[cite: 17].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    J'installe généralement l'adoucisseur à l'arrivée d'eau principale de la maison, juste après le compteur, afin de traiter l'ensemble de l'eau qui alimente votre logement[cite: 17].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    L'entretien régulier consiste principalement à recharger le bac en sel adoucisseur selon votre consommation, ainsi qu'à effectuer une maintenance de contrôle annuelle que je peux assurer[cite: 17].
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="contact" className="py-16 bg-accent text-white text-center">
                    <div className="max-w-4xl mx-auto px-4 space-y-6">
                        ...
                        <p className="text-slate-100">Contactez-moi pour obtenir une analyse rapide de la dureté de votre eau et un devis personnalisé partout en Normandie[cite: 17].</p>
