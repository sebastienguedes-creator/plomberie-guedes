            ...
            <div className="bg-slate-950 text-slate-100 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <div className="lg:col-span-7 space-y-6">
                                <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider text-accent">
                                    <Droplets className="w-4 h-4" aria-hidden="true" /> Traitement de l'eau & Anti-Calcaire
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                                    <Link
                                        to="/contact"
                                        aria-label="Demander un devis pour un adoucisseur"
                            ...
                            <aside className="lg:col-span-5 bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-2xl space-y-6">
                                ...
                                <ul className="space-y-4 text-sm text-slate-300">
                                    ...
                                    <li className="flex items-start gap-3">
                                        <Wrench className="w-5 h-5 text-accent shrink-0 mt-0.5" aria-hidden="true" />
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
                        <header className="text-center space-y-4 max-w-3xl mx-auto">
                            ...
                            <p className="text-slate-400 text-sm sm:text-base">
                                J'interviens sur la majorité du territoire normand, notamment dans l'Eure (27), la Seine-Maritime (76), le Calvados (14) et l'Orne (61)[cite: 12] :
                            </p>
                        </header>
                                    ...
                                    <div className="flex flex-wrap justify-center gap-2.5">
                                        {[
                                            ...
                                            <span key={i} className="bg-slate-950 border border-slate-800 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-slate-300 flex items-center gap-2 hover:border-accent/40 transition-colors">
                                                <MapPin className="w-3.5 h-3.5 text-accent" aria-hidden="true" /> Adoucisseur {lieu}
                                            </span>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    return (
                                        <article key={chantier.id} className="bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden flex flex-col h-[520px] hover:border-slate-700 transition-colors shadow-lg shadow-black/20">
                                            ...
                                            <button
                                                ...
                                                aria-label={`Agrandir la photo et lire les détails de l'installation à ${chantier.ville}`}
                                            >
                                                <img
                ...
                {selectedChantier && (
                    <div
                        ...
                        role="dialog"
                        aria-modal="true"
                        aria-label="Aperçu détaillé du chantier d'adoucisseur"
                        tabIndex="-1"
                    >
                        <button
                            type="button"
                        ...
                        >
                            <div className="lg:w-1/2 p-6 bg-slate-950 flex items-center justify-center">
                                <img
                                    ...
                                    alt={`Installation adoucisseur à ${selectedChantier.ville}`}
