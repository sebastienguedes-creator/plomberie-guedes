...
export default function AdoucisseurEau() {
    ...
    return (
        <>
            <Helmet>
                <title>Installation Adoucisseur d'Eau Normandie : Départements & Villes | GUEDES</title>
                <meta
                    name="description"
                    content="Pose et entretien d'adoucisseur d'eau partout en Normandie (Eure, Seine-Maritime, Calvados, Manche, Orne). J'interviens dans toutes les préfectures et sous-préfectures."
                />
                <link rel="canonical" href="https://www.plomberie-guedes.fr/installation-adoucisseur-eau" />
                <meta property="og:title" content="Installation Adoucisseur d'Eau Normandie | GUEDES" />
                <meta property="og:description" content="Pose et entretien d'adoucisseur d'eau partout en Normandie. J'interviens dans toutes les préfectures et sous-préfectures." />
                <meta property="og:url" content="https://www.plomberie-guedes.fr/installation-adoucisseur-eau" />
