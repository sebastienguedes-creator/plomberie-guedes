...
export default function SalleDeBain() {
    ...
    return (
        <>
            <Helmet>
                <title>Rénovation Salle de Bain Normandie : Clé en main | GUEDES</title>
                <meta
                    name="description"
                    content="Artisan spécialiste en rénovation de salle de bain en Normandie. J'interviens dans toutes les préfectures et sous-préfectures. Douche à l'italienne, aménagement PMR."
                />
                <link rel="canonical" href="https://www.plomberie-guedes.fr/renovation-salle-de-bain" />
                {/* Open Graph */}
                <meta property="og:title" content="Rénovation Salle de Bain Normandie : Clé en main | GUEDES" />
                <meta property="og:description" content="Artisan spécialiste en rénovation de salle de bain en Normandie. J'interviens dans toutes les préfectures et sous-préfectures. Douche à l'italienne, aménagement PMR." />
                <meta property="og:url" content="https://www.plomberie-guedes.fr/renovation-salle-de-bain" />
