        ...
        "@graph": [
            {
                ...
                "description": "Installation, entretien et dépannage de VMC (Simple flux, Double flux) et systèmes de ventilation pour une qualité d'air optimale."
            },
            {
                "@type": "FAQPage",
            ...
            <div className="bg-slate-950 text-slate-100 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <div className="lg:col-span-7 space-y-6">
                                ...
                                <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                                    Lutter contre l'humidité, éliminer les polluants intérieurs et optimiser votre confort thermique : confiez la pose ou la maintenance de votre VMC à un professionnel qualifié[cite: 15].
                                </p>
                            ...
                            <div className="lg:col-span-5 bg-slate-900 border border-slate-800 p-8 rounded-3xl space-y-6">
                                ...
                                <ul className="space-y-4 text-sm text-slate-300">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span><strong>Anti-humidité :</strong> Prévention efficace de la condensation et des moisissures sur les murs[cite: 15].</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Wind className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                                        <span><strong>Air sain :</strong> Évacuation des polluants intérieurs, COV et odeurs du quotidien[cite: 15].</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Home className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                                        <span><strong>Économies d'énergie :</strong> Optimisation des flux d'air pour réduire les pertes de chauffage[cite: 15].</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base">
                                De l'étude de votre habitat à la mise en service, profitez d'une installation conforme et performante[cite: 15].
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
                                ...
                                <p className="text-sm text-slate-400">
                                    Autoréglable ou hygroréglable, elle extrait l'air vicié des pièces humides (cuisine, sdb, wc) en régulant le débit selon l'humidité[cite: 15].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
                                ...
                                <p className="text-sm text-slate-400">
                                    Récupère les calories de l'air sortant pour réchauffer l'air neuf entrant. Confort thermique accru et économies significatives[cite: 15].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
                                ...
                                <p className="text-sm text-slate-400">
                                    Nettoyage des réseaux, contrôle du caisson moteur, remplacement des filtres et diagnostic en cas de panne ou de nuisances sonores[cite: 15].
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-16 bg-slate-950 border-b border-slate-800">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto text-sm">
                            J'interviens pour l'installation, l'entretien et le dépannage de vos systèmes de ventilation sur les communes suivantes[cite: 15] :
                        </p>
                        <div className="flex flex-wrap justify-center gap-3 pt-2">
                            {[
                                ...
                                "VMC Saint-Lô (50)", "VMC Cherbourg-en-Cotentin (50)", "VMC Avranches (50)",
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    La VMC permet de renouveler l'air intérieur, d'évacuer l'humidité excessive, de prévenir l'apparition de moisissures et d'améliorer la qualité de l'air que vous respirez[cite: 15].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    La VMC simple flux extrait l'air vicié en faisant entrer de l'air neuf par des entrées d'air. La VMC double flux récupère quant à elle les calories de l'air extrait pour préchauffer l'air entrant, offrant ainsi un meilleur confort thermique et des économies d'énergie[cite: 15].
                                </p>
                            </div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
                                ...
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    Il est recommandé de nettoyer les bouches d'extraction tous les 3 à 6 mois et de faire réaliser un entretien complet du bloc moteur et des gaines par un professionnel tous les 2 à 3 ans[cite: 15].
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="contact" className="py-16 bg-accent text-white text-center">
                    <div className="max-w-4xl mx-auto px-4 space-y-6">
                        ...
                        <p className="text-slate-100">Contactez-moi pour discuter de votre projet d'installation ou d'entretien de VMC[cite: 15].</p>
