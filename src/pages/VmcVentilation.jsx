...
export default function VmcVentilation() {
    ...
    return (
        <>
            <Helmet>
                <title>Installation & Entretien VMC Ventilation | GUEDES</title>
                <meta
                    name="description"
                    content="Améliorez la qualité de votre air intérieur. Installation et entretien de VMC simple flux et double flux par la SARL Anthony GUEDES."
                />
                <link rel="canonical" href="https://www.plomberie-guedes.fr/vmc-ventilation" />
                <meta property="og:title" content="Installation & Entretien VMC Ventilation | GUEDES" />
                <meta property="og:description" content="Améliorez la qualité de votre air intérieur. Installation et entretien de VMC simple flux et double flux par la SARL Anthony GUEDES." />
                <meta property="og:url" content="https://www.plomberie-guedes.fr/vmc-ventilation" />
            ...
            <div className="bg-slate-950 text-slate-100 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <div className="lg:col-span-7 space-y-6">
                                ...
                                <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                                    Lutter contre l'humidité, éliminer les polluants intérieurs et optimiser votre confort thermique : confiez la pose ou la maintenance de votre VMC à un professionnel qualifié.
                                </p>
                ...
                <section className="py-16 bg-slate-950 border-b border-slate-800">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto text-sm">
                            J'interviens pour l'installation, l'entretien et le dépannage de vos systèmes de ventilation sur les communes suivantes :
                        </p>
                ...
                <section id="contact" className="py-16 bg-accent text-white text-center">
                    <div className="max-w-4xl mx-auto px-4 space-y-6">
                        ...
                        <p className="text-slate-100">Contactez-moi pour discuter de votre projet d'installation ou d'entretien de VMC.</p>
